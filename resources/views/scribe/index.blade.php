    ...
    <div id="toc">
                ...
                <li class="tocify-item level-1" data-unique="clients">
                    <a href="#clients">Clients</a>
                                ...
                                <a href="#clients-GETapi-v1-clients">List all clients</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="clients-POSTapi-v1-clients">
                                <a href="#clients-POSTapi-v1-clients">POST api/v1/clients</a>
                            </li>
                ...
                <li class="tocify-item level-1" data-unique="orders">
                    <a href="#orders">Orders</a>
                                ...
                                <a href="#orders-DELETEapi-v1-orders--id-">DELETE api/v1/orders/{id}</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="orders-POSTapi-v1-orders-restore--id--">
                                <a href="#orders-POSTapi-v1-orders-restore--id--">POST api/v1/orders/restore/{id?}</a>
                            </li>
                                                                        </ul>
                            </ul>
                ...
                <li class="tocify-item level-1" data-unique="products">
                    <a href="#products">Products</a>
                                ...
                                <a href="#products-GETapi-v1-products">List all products with filters</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="products-POSTapi-v1-products">
                                <a href="#products-POSTapi-v1-products">POST api/v1/products</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="products-GETapi-v1-products--id-">
                                <a href="#products-GETapi-v1-products--id-">Retrieve a product by ID</a>
                            </li>
                                ...
                                <a href="#products-DELETEapi-v1-products--id-">Delete a product by ID</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="products-POSTapi-v1-products-restore--id--">
                                <a href="#products-POSTapi-v1-products-restore--id--">Restore a product by ID</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="products-POSTapi-v1-clients-restore--id--">
                                <a href="#products-POSTapi-v1-clients-restore--id--">Restore a product by ID</a>
                            </li>
                                                                        </ul>
                            </ul>
                ...
                <li class="tocify-item level-1" data-unique="profile">
                    <a href="#profile">Profile</a>
                                ...
                                <a href="#profile-GETapi-v1-me">GET api/v1/me</a>
                            </li>
                                                                        </ul>
                            </ul>
            </div>
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>required. Example: <code>admin@admin.com</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>password</code></b>&nbsp;&nbsp;
<small>string.</small>&nbsp;
...
<p>Example: <code>application/json</code></p>
                ...
                <h1 id="clients">Clients</h1>
                                ...
                                <h2 id="clients-GETapi-v1-clients">List all clients</h2>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="query"                data-endpoint="GETapi-v1-clients"
               value="b"
               data-component="body">
    <br>
<p>O campo value não pode ser superior a 100 caracteres. Example: <code>b</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="sort_by"                data-endpoint="GETapi-v1-clients"
               value=""
               data-component="body">
    <br>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="sort_order"                data-endpoint="GETapi-v1-clients"
               value="asc"
               data-component="body">
    <br>
...
<i>optional</i> &nbsp;
 &nbsp;
                <label data-endpoint="GETapi-v1-clients" style="display: none">
            <input type="radio" name="with_trashed"
                   value="true"
                   data-endpoint="GETapi-v1-clients"
                   data-component="body"             >
            <code>true</code>
        </label>
        <label data-endpoint="GETapi-v1-clients" style="display: none">
...
<p>Example: <code>true</code></p>
                    ...
                    <h2 id="clients-POSTapi-v1-clients">POST api/v1/clients</h2>
...
<div class="bash-example">
    ...
    \"email\": \"john@mail.com\",
    \"phone\": \"architecto\",
    \"dob\": \"2025-11-11T10:54:06\",
    \"address\": \"architecto\",
    \"complement\": \"architecto\",
    \"neighbor\": \"architecto\",
    \"postal_code\": 4326.41688,
    \"sign_date\": \"2025-11-11T10:54:06\"
}"
</code></pre></div>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="dob"                data-endpoint="POSTapi-v1-clients"
               value="2025-11-11T10:54:06"
               data-component="body">
    <br>
<p>O campo value deve ser uma data válida. Example: <code>2025-11-11T10:54:06</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="complement"                data-endpoint="POSTapi-v1-clients"
               value="architecto"
               data-component="body">
    <br>
<p>Example: <code>architecto</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="neighbor"                data-endpoint="POSTapi-v1-clients"
               value="architecto"
               data-component="body">
    <br>
<p>Example: <code>architecto</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               step="any"               name="postal_code"                data-endpoint="POSTapi-v1-clients"
               value="4326.41688"
               data-component="body">
    <br>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="sign_date"                data-endpoint="POSTapi-v1-clients"
               value="2025-11-11T10:54:06"
               data-component="body">
    <br>
<p>O campo value deve ser uma data válida. Example: <code>2025-11-11T10:54:06</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="query"                data-endpoint="GETapi-v1-orders"
               value="b"
               data-component="body">
    <br>
<p>O campo value não pode ser superior a 100 caracteres. Example: <code>b</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <label data-endpoint="GETapi-v1-orders" style="display: none">
            <input type="radio" name="with_trashed"
                   value="true"
                   data-endpoint="GETapi-v1-orders"
                   data-component="body"             >
            <code>true</code>
        </label>
        <label data-endpoint="GETapi-v1-orders" style="display: none">
...
<small>number</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="client_id"                data-endpoint="POSTapi-v1-orders"
               value="4326.41688"
               data-component="body">
    <br>
<p>The <code>id</code> of an existing record in the clients table. Example: <code>4326.41688</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string[]</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="products[0]"                data-endpoint="POSTapi-v1-orders"
               data-component="body">
        <input type="text" style="display: none"
               name="products[1]"                data-endpoint="POSTapi-v1-orders"
               data-component="body">
    <br>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="id"                data-endpoint="PUTapi-v1-orders--id-"
               value="architecto"
               data-component="url">
    <br>
<p>The ID of the order. Example: <code>architecto</code></p>
...
<small>number</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="client_id"                data-endpoint="PUTapi-v1-orders--id-"
               value="4326.41688"
               data-component="body">
    <br>
<p>The <code>id</code> of an existing record in the clients table. Example: <code>4326.41688</code></p>
...
<small>string[]</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="products[0]"                data-endpoint="PUTapi-v1-orders--id-"
               data-component="body">
        <input type="text" style="display: none"
               name="products[1]"                data-endpoint="PUTapi-v1-orders--id-"
               data-component="body">
    <br>
                    ...
                    <h2 id="orders-DELETEapi-v1-orders--id-">DELETE api/v1/orders/{id}</h2>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="id"                data-endpoint="DELETEapi-v1-orders--id-"
               value="architecto"
               data-component="url">
    <br>
<p>The ID of the order. Example: <code>architecto</code></p>
                    ...
                    <h2 id="orders-POSTapi-v1-orders-restore--id--">POST api/v1/orders/restore/{id?}</h2>
...
<span id="example-requests-POSTapi-v1-orders-restore--id--">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request POST \
    "http://localhost/api/v1/orders/restore/architecto" \
    --header "Authorization: Bearer {YOUR_AUTH_KEY}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<span id="example-responses-POSTapi-v1-orders-restore--id--">
</span>
<span id="execution-results-POSTapi-v1-orders-restore--id--" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-v1-orders-restore--id--"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-POSTapi-v1-orders-restore--id--"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-v1-orders-restore--id--" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-v1-orders-restore--id--">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-POSTapi-v1-orders-restore--id--" data-method="POST"
      data-path="api/v1/orders/restore/{id?}"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-v1-orders-restore--id--', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-POSTapi-v1-orders-restore--id--"
                    onclick="tryItOut('POSTapi-v1-orders-restore--id--');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-v1-orders-restore--id--"
                    onclick="cancelTryOut('POSTapi-v1-orders-restore--id--');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-v1-orders-restore--id--"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-black">POST</small>
            <b><code>api/v1/orders/restore/{id?}</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Authorization</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="POSTapi-v1-orders-restore--id--"
               value="Bearer {YOUR_AUTH_KEY}"
               data-component="header">
    <br>
<p>Example: <code>Bearer {YOUR_AUTH_KEY}</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-v1-orders-restore--id--"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-v1-orders-restore--id--"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="id"                data-endpoint="POSTapi-v1-orders-restore--id--"
               value="architecto"
               data-component="url">
    <br>
<p>The ID of the . Example: <code>architecto</code></p>
                ...
                <h1 id="products">Products</h1>
                                ...
                                <h2 id="products-GETapi-v1-products">List all products with filters</h2>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="query"                data-endpoint="GETapi-v1-products"
               value="architecto"
               data-component="body">
    <br>
<p>Example: <code>architecto</code></p>
...
<p>Example: <code>true</code></p>
                    ...
                    <h2 id="products-POSTapi-v1-products">POST api/v1/products</h2>
...
<div class="bash-example">
    ...
    --form "status=1"\
    --form "photo=@/tmp/phpd99s9uo45pt1d1cOUUq" </code></pre></div>
...
body.append('name', 'Item1 1');
body.append('price', '123.99');
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>required. Example: <code>Item1 1</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>required. Example: <code>123.99</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>file</small>&nbsp;
 ...
 &nbsp;
                <input type="file" style="display: none"
                              name="photo"                data-endpoint="POSTapi-v1-products"
               value=""
               data-component="body">
    <br>
<p>Example: <code>/tmp/phpd99s9uo45pt1d1cOUUq</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="status"                data-endpoint="POSTapi-v1-products"
               value="1"
               data-component="body">
    <br>
<p>required. Example: <code>1</code></p>
                    ...
                    <h2 id="products-GETapi-v1-products--id-">Retrieve a product by ID</h2>
...
<div class="bash-example">
    ...
    --form "category_id=architecto"\
    --form "status=1"\
    --form "photo=@/tmp/phpv61m143fe8305zWtY21" </code></pre></div>
...
<small>file</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Example: <code>/tmp/phpv61m143fe8305zWtY21</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>status</code></b>&nbsp;&nbsp;
<small>number</small>&nbsp;
<i>optional</i> &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="status"                data-endpoint="PUTapi-v1-products--id-"
               value="1"
               data-component="body">
    <br>
<p>required. Example: <code>1</code></p>
                    ...
                    <h2 id="products-DELETEapi-v1-products--id-">Delete a product by ID</h2>
...
<p>The ID of the product. Example: <code>1</code></p>
                    ...
                    <h2 id="products-POSTapi-v1-products-restore--id--">Restore a product by ID</h2>
...
<span id="example-requests-POSTapi-v1-products-restore--id--">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request POST \
    "http://localhost/api/v1/products/restore/1" \
    --header "Authorization: Bearer {YOUR_AUTH_KEY}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<span id="example-responses-POSTapi-v1-products-restore--id--">
            <blockquote>
            <p>Example response (200):</p>
        </blockquote>
                <pre>
...
<span id="execution-results-POSTapi-v1-products-restore--id--" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-v1-products-restore--id--"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-POSTapi-v1-products-restore--id--"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-v1-products-restore--id--" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-v1-products-restore--id--">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-POSTapi-v1-products-restore--id--" data-method="POST"
      data-path="api/v1/products/restore/{id?}"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-v1-products-restore--id--', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-POSTapi-v1-products-restore--id--"
                    onclick="tryItOut('POSTapi-v1-products-restore--id--');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-v1-products-restore--id--"
                    onclick="cancelTryOut('POSTapi-v1-products-restore--id--');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-v1-products-restore--id--"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-black">POST</small>
            <b><code>api/v1/products/restore/{id?}</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Authorization</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="POSTapi-v1-products-restore--id--"
               value="Bearer {YOUR_AUTH_KEY}"
               data-component="header">
    <br>
<p>Example: <code>Bearer {YOUR_AUTH_KEY}</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-v1-products-restore--id--"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-v1-products-restore--id--"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="id"                data-endpoint="POSTapi-v1-products-restore--id--"
               value="1"
               data-component="url">
    <br>
<p>The ID of the product. Example: <code>1</code></p>
                    ...
                    <h2 id="products-POSTapi-v1-clients-restore--id--">Restore a product by ID</h2>
...
<span id="example-requests-POSTapi-v1-clients-restore--id--">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request POST \
    "http://localhost/api/v1/clients/restore/1" \
    --header "Authorization: Bearer {YOUR_AUTH_KEY}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<span id="example-responses-POSTapi-v1-clients-restore--id--">
            <blockquote>
            <p>Example response (200):</p>
        </blockquote>
                <pre>
...
<span id="execution-results-POSTapi-v1-clients-restore--id--" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-v1-clients-restore--id--"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-POSTapi-v1-clients-restore--id--"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-v1-clients-restore--id--" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-v1-clients-restore--id--">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-POSTapi-v1-clients-restore--id--" data-method="POST"
      data-path="api/v1/clients/restore/{id?}"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-v1-clients-restore--id--', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-POSTapi-v1-clients-restore--id--"
                    onclick="tryItOut('POSTapi-v1-clients-restore--id--');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-v1-clients-restore--id--"
                    onclick="cancelTryOut('POSTapi-v1-clients-restore--id--');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-v1-clients-restore--id--"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-black">POST</small>
            <b><code>api/v1/clients/restore/{id?}</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Authorization</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="POSTapi-v1-clients-restore--id--"
               value="Bearer {YOUR_AUTH_KEY}"
               data-component="header">
    <br>
<p>Example: <code>Bearer {YOUR_AUTH_KEY}</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-v1-clients-restore--id--"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-v1-clients-restore--id--"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="id"                data-endpoint="POSTapi-v1-clients-restore--id--"
               value="1"
               data-component="url">
    <br>
<p>The ID of the product. Example: <code>1</code></p>
                ...
                <h1 id="profile">Profile</h1>
                                ...
                                <h2 id="profile-GETapi-v1-me">GET api/v1/me</h2>
