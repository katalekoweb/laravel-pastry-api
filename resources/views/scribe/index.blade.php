    ...
    <div id="toc">
                ...
                <li class="tocify-item level-1" data-unique="auth">
                    <a href="#auth">Auth</a>
                                ...
                                <a href="#auth-POSTapi-v1-register">POST api/v1/register</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="auth-POSTapi-v1-login">
                                <a href="#auth-POSTapi-v1-login">POST api/v1/login</a>
                            </li>
                ...
                <li class="tocify-item level-1" data-unique="clients">
                    <a href="#clients">Clients</a>
                                    ...
                                    <ul id="tocify-subheader-clients" class="tocify-subheader">
                                                    <li class="tocify-item level-2" data-unique="clients-GETapi-v1-clients--id-">
                                <a href="#clients-GETapi-v1-clients--id-">Retrieve a client by ID</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="clients-PUTapi-v1-clients--id-">
                                <a href="#clients-PUTapi-v1-clients--id-">Update a client</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="clients-DELETEapi-v1-clients--id-">
                                <a href="#clients-DELETEapi-v1-clients--id-">Delete a client by ID</a>
                            </li>
                                                                        </ul>
                            </ul>
            </div>
...
<p>You can retrieve your token by visiting your dashboard and clicking <b>Generate API token</b>.</p>
        ...
        <h1 id="auth">Auth</h1>
                                ...
                                <h2 id="auth-POSTapi-v1-register">POST api/v1/register</h2>
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>required. Example: <code>Joao</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>required. Example: <code>john@mail.com</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>required. Example: <code>|]|{+-</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>required. Example: <code>architecto</code></p>
        </div>
        </form>

                    <h2 id="auth-POSTapi-v1-login">POST api/v1/login</h2>
...
<code class="language-json" style="max-height: 300px;">{
    &quot;message&quot;: &quot;Sess&atilde;o terminada com sucesso&quot;
}</code>
 </pre>
    </span>
...
<p>Example: <code>application/json</code></p>
                ...
                <h1 id="clients">Clients</h1>
                                ...
                                <h2 id="clients-GETapi-v1-clients--id-">Retrieve a client by ID</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>Get a list of clients with optional pagination.</p>
...
<div class="bash-example">
    ...
    --get "http://localhost/api/v1/clients/architecto" \
    --header "Authorization: Bearer {YOUR_AUTH_KEY}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost/api/v1/clients/architecto"
);
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="id"                data-endpoint="GETapi-v1-clients--id-"
               value="architecto"
               data-component="url">
    <br>
<p>The ID of the client. Example: <code>architecto</code></p>
                    ...
                    <h2 id="clients-PUTapi-v1-clients--id-">Update a client</h2>
...
<div class="bash-example">
    ...
    \"phone\": \"+1122334455\",
    \"dob\": \"2025-11-07T18:00:25\",
    \"address\": \"789 Oak St\",
    \"complement\": \"architecto\",
    \"neighbor\": \"architecto\",
    \"postal_code\": 4326.41688,
    \"sign_date\": \"2025-11-07T18:00:25\"
}"
</code></pre></div>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="name"                data-endpoint="PUTapi-v1-clients--id-"
               value="Jane"
               data-component="body">
    <br>
<p>Client's first name. Example: <code>Jane</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>email</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="email"                data-endpoint="PUTapi-v1-clients--id-"
               value="jane.doe@example.com"
               data-component="body">
    <br>
<p>Client's email. Example: <code>jane.doe@example.com</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="phone"                data-endpoint="PUTapi-v1-clients--id-"
               value="+1122334455"
               data-component="body">
    <br>
<p>Client's phone number. Example: <code>+1122334455</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="dob"                data-endpoint="PUTapi-v1-clients--id-"
               value="2025-11-07T18:00:25"
               data-component="body">
    <br>
<p>O campo value deve ser uma data válida. Example: <code>2025-11-07T18:00:25</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="address"                data-endpoint="PUTapi-v1-clients--id-"
               value="789 Oak St"
               data-component="body">
    <br>
<p>Client's address. Example: <code>789 Oak St</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="complement"                data-endpoint="PUTapi-v1-clients--id-"
               value="architecto"
               data-component="body">
    <br>
<p>Example: <code>architecto</code></p>
                ...
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>neighbor</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="neighbor"                data-endpoint="PUTapi-v1-clients--id-"
               value="architecto"
               data-component="body">
    <br>
<p>Example: <code>architecto</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="postal_code"                data-endpoint="PUTapi-v1-clients--id-"
               value="4326.41688"
               data-component="body">
    <br>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="sign_date"                data-endpoint="PUTapi-v1-clients--id-"
               value="2025-11-07T18:00:25"
               data-component="body">
    <br>
<p>O campo value deve ser uma data válida. Example: <code>2025-11-07T18:00:25</code></p>
                    ...
                    <h2 id="clients-DELETEapi-v1-clients--id-">Delete a client by ID</h2>
